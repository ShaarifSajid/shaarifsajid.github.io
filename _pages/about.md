...
I am a graduate student (MS CS) at Georgia Tech and my primary areas of interest belong to the domains of network security, Internet measurement and computing systems. I am currently studying advanced courses on operating systems and high performance computer architecture. I am looking for full-time positions in software and security engineering/analyst roles. You can find my CV [here](http://shaarifsajid.github.io/files/sajid_cv_mscs.pdf). In the past, I have actively worked on numerous research projects - here are some of them:
